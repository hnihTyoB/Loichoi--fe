  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-black tracking-tight text-kawaii-mocha">Hộp Thư Thông Báo 🔔</h1>
          <p className="text-sm text-kawaii-mocha/70">Tin nhắn hệ thống và thông báo từ cộng đồng</p>
        </div>
        <Button variant="outline" size="sm" className="gap-2 rounded-full font-bold">
          <CheckCheck className="h-4 w-4" /> Đã đọc tất cả 🌸
        </Button>
      </div>
