  ...
  return (
    <Card className="rounded-[2.5rem] border-2 border-kawaii-sky/60 bg-card/95 shadow-cloud backdrop-blur-md">
      <CardHeader className="space-y-2 text-center pb-4">
        ...
        <CardTitle className="text-2xl font-black text-kawaii-mocha">Chào Mừng Trở Lại!</CardTitle>
        <CardDescription className="text-sm text-kawaii-mocha/70">
          Đăng nhập để vào thế giới bàn phím Cinnamoroll ☁️
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <div className="relative flex items-center justify-center text-xs uppercase my-2">
          ...
          <span className="bg-card px-3 text-kawaii-mocha/50 font-bold">hoặc email</span>
          <div className="border-t border-kawaii-sky/40 w-full" />
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between ml-1">
              <label className="text-xs font-bold text-kawaii-mocha">Mật khẩu</label>
              <Link
          ...
          <Button type="submit" className="w-full h-12 text-base font-bold shadow-cloud mt-2" disabled={isLoading}>
            {isLoading ? "Đang bay đến máy chủ ☁️..." : "Đăng Nhập Ngay ✨"}
          </Button>
        </form>
      </CardContent>
